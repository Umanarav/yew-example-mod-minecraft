...
public class ModSounds {
    public static final Identifier JOINT_SMOKE_ID = new Identifier("examplemod:joint_smoke");
    public static final SoundEvent JOINT_SMOKE = SoundEvent.of(JOINT_SMOKE_ID);
    public static final Identifier BONG_SMOKE_ID = new Identifier("examplemod:bong_smoke");
    public static final SoundEvent BONG_SMOKE = SoundEvent.of(BONG_SMOKE_ID);
    
    public static final Identifier WEED_MUSIC_DISC_ID = new Identifier("examplemod:weed_music_disc");
    public static final SoundEvent WEED_MUSIC_DISC = SoundEvent.of(WEED_MUSIC_DISC_ID);

    public static final Identifier ANARCHY_REIGNS_MUSIC_DISC_ID = new Identifier("examplemod:anarchy_reigns_music_disc");
